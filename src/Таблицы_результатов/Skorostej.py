...
class MyHeaders(QWidget):
    ...
    def initUI(self):        
        ...
        self.table.setSpan(0, 2, 1, 3)
        self.table.setSpan(0, 5, 2, 1)
        self.table.setSpan(0, 6, 2, 1)    
        #fnt = self.table.font()
        #fnt.setPointSize(12)
        #fnt.setBold(True)
        ...
        for j in range(7):                #self.model.columnCount()):
...
class SkorostejClass(QWidget):
    ...
    def initUI(self):
        ...
        self.table.horizontalHeader().setVisible(False)
        self.table.verticalHeader().setVisible(False)
        self.model = pandasModel(self.read_data('SevenColumnsData.csv')) 
        self.table.setModel(self.model)
