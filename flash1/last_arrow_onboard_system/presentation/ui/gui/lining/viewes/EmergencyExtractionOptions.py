...
from PySide6.QtWidgets import QGridLayout, QVBoxLayout, QPushButton, QLabel, QDoubleSpinBox, QDialog, QWidget, QCheckBox
...
class EmergencyExtractionOptions(QDialog):
    def __init__(self, 
        ...
        layout.addWidget(self.__autoBranchCheckBox, 6, 1, 1, 2)
        layout.addWidget(self.__acceptButton, 7, 2, 1, 2)
        layout.addWidget(reject_button, 7, 0, 1, 2)
