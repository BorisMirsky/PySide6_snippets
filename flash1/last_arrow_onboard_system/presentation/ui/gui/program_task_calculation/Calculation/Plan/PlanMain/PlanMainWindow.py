...
class PlanView(QWidget):
    def __init__(self,  calculation_result, parent: QWidget = None, window: Window = None):
    ...
    def __openPlanParameters(self):
        ...
        self.__layout.addWidget(self.__currentView)
        self.__layout.setCurrentWidget(self.__currentView)
        #setWindowTitle(self, "План > Параметры") 
        self.__window.setTitle("План > Параметры")
    ...
    def __openPlanShifts(self):
        self.__clearCurrentView()
        self.__currentView = ShiftsMainWidget(self.__calculation_result, self.planMain.currentPicket)
        self.__currentView.closePlanShiftsSignal.connect(self.__openPlanMain)
        self.__currentView.passDataSignal.connect(self.planMain.rerenderCharts)
        self.__currentView.updateCalculationResultSignal.connect(self.update_calculation_result)
        self.__layout.addWidget(self.__currentView)
        self.__layout.setCurrentWidget(self.__currentView)
        self.__window.setTitle("План > Сдвиги")
...
class PlanMainWidget(QWidget):
    ...
    def __init__(self, calculation_result,
        ...
        self.model = VerticalLineModel(self.options.start_picket.meters, (position_min, position_max), accValue=True)
