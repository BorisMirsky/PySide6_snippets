...
class ProfileParametersWidget(QWidget):
    ...
    def __init__(self,
        ...
        self.model1 = VerticalLineModel(self.options.start_picket.meters, rangeX)
        self.model2 = VerticalLineModel(self.options.start_picket.meters + self.position_multiplyer * self.plan_model.elements()[0].to_dict()['end'], rangeX)
        self.model3 = VerticalLineModel(0, rangeX)
