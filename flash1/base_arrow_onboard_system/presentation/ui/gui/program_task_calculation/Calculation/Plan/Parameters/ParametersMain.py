...
#        self.changes_list.append(self.plan_model_immutable_copy)
        ...
        self.counter = 0
        self.model1 = VerticalLineModel(self.startPicket + self.position_multiplyer * self.get_summary_row(self.plan_model.elements(), self.counter).to_dict()['start'])
        self.model2 = VerticalLineModel(self.startPicket + self.position_multiplyer * self.get_summary_row(self.plan_model.elements(), self.counter).to_dict()['end'])
        self.model3 = VerticalLineModel(-1)
        #
