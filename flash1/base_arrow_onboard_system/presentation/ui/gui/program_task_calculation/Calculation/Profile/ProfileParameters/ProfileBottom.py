...
class BottomWidget(QWidget):
    ...
    def __init__(self,
        ...
        self.groupbox2.setStyleSheet("QGroupBox{font-size: 22px;font-weight: bold;}")
    ...
    def set_groupbox_title_style(self, segment_type: str):
        segment_type_style = {
            "Круговая кривая": "QGroupBox{font-size:18px; font-weight:bold;} QGroupBox:title{color:red;}",
