...
class ProgramTaskCalculationOptionsView(QWidget):
    ...
    def __setDetailedRestrictions(self) -> None:
        ...
        try:
            ...
            self.detailedRestrictionsWidget = DetailedRestrictionsWidget(options)
    ...
    def __setOptionsReconstruction(self) -> None:
        restrictions = self.windowSettingsRestrictions.edited_restrictions()
        self.optionsReconstruction = OptionsReconstruction(restrictions)
    ...
    def __onSelectProgramTask(self) ->None:
        try:
            if self.__programTask is None:
                QMessageBox.critical(self, QCoreApplication.translate('Lining trip/options/view',
                                                                      'Read program task file error'),
                                     QCoreApplication.translate('Lining trip/options/view',
                                                                'Program task was not selected'))
                return
