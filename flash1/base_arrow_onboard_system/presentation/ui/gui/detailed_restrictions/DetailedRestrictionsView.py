...
from .VerticalLine import VerticalLineModel, NumpyTableModel
import numpy as np
...
class DetailedRestrictionsWidget(QWidget):
    ...
    def __init__(self,
        ...
        for i in range(min(round(self.position_max.item()), 0), max(round(self.position_max.item()), 0)):
            self.strelograph_top_line_series.append(self.start_picket + i * self.position_multiplyer,
                                                  self.__restrictions['segments'][0]['shifting_left'])
            self.strelograph_bottom_line_series.append(self.start_picket + i * self.position_multiplyer,
                                                     self.__restrictions['segments'][0]['shifting_right'])
        ...
        for i in range(0, round(self.position_max.item())):
        ...
        self.situation_empty_chart.addSeries(self.marker_series_1)
        self.situation_empty_chart.addSeries(self.marker_series_2)
        self.situation_empty_chart.addSeries(self.marker_series_3)
        self.situation_empty_chart.addSeries(self.marker_series_4)
        self.situation_empty_chart.addSeries(self.marker_series_5)
        self.situation_empty_chart.addSeries(self.marker_series_6)
        self.situation_empty_chart.addSeries(self.marker_series_7)
        self.situation_empty_chart.addSeries(self.marker_series_8)
        self.situation_empty_chart.addSeries(self.marker_series_9)
        self.situation_empty_chart.addSeries(self.marker_series_10)
        ...
        #
        marker_position_dict = {RailwayMarkerLocation.Left: 7,
                         RailwayMarkerLocation.Middle: 0,
                         RailwayMarkerLocation.Right: -7}
        ...
        if self.markers:
            for marker in self.markers:
                if marker[0].type == RailwayMarkerType.UNDEFINED:
                    ...
                    self.marker_series_1.attachAxis(self.situation_empty_chart.axisX())
                    self.marker_series_1.attachAxis(self.situation_empty_chart.axisY())
                    ...
                    self.marker_series_2.attachAxis(self.situation_empty_chart.axisX())
                    self.marker_series_2.attachAxis(self.situation_empty_chart.axisY())
                    ...
                    self.marker_series_3.attachAxis(self.situation_empty_chart.axisX())
                    self.marker_series_3.attachAxis(self.situation_empty_chart.axisY())
                    ...
                    self.marker_series_4.attachAxis(self.situation_empty_chart.axisX())
                    self.marker_series_4.attachAxis(self.situation_empty_chart.axisY())
                    ...
                    self.marker_series_5.attachAxis(self.situation_empty_chart.axisX())
                    self.marker_series_5.attachAxis(self.situation_empty_chart.axisY())
                    ...
                    self.marker_series_6.attachAxis(self.situation_empty_chart.axisX())
                    self.marker_series_6.attachAxis(self.situation_empty_chart.axisY())
                    ...
                    self.marker_series_7.attachAxis(self.situation_empty_chart.axisX())
                    self.marker_series_7.attachAxis(self.situation_empty_chart.axisY())
                    ...
                    self.marker_series_8.attachAxis(self.situation_empty_chart.axisX())
                    self.marker_series_8.attachAxis(self.situation_empty_chart.axisY())
                    ...
                    self.marker_series_9.attachAxis(self.situation_empty_chart.axisX())
                    self.marker_series_9.attachAxis(self.situation_empty_chart.axisY())
                    ...
                    self.marker_series_10.attachAxis(self.situation_empty_chart.axisX())
                    self.marker_series_10.attachAxis(self.situation_empty_chart.axisY())
